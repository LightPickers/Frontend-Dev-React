...
function ProductCard({ name, condition, original_price, selling_price, imageUrl, tag }) {
  if (!name) {
    console.error("Invalid product data:", { name, original_price, selling_price, imageUrl, tag });
    return null; // 如果數據無效，返回空
  }
