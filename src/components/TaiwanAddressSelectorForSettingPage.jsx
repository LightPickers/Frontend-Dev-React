...
function TaiwanAddressSelectorForSettingPage({ disabled = false, errors }) {
...
TaiwanAddressSelectorForSettingPage.propTypes = {
  disabled: PropTypes.bool,
  errors: PropTypes.object,
};

export default TaiwanAddressSelectorForSettingPage;
