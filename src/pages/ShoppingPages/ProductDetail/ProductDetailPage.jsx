...
import ProductUnavailablePage from "@pages/ShoppingPages/ProductDetail/ProductUnavailablePage";
...
function ProductDetailPage() {
  ...
  const [
    ...
    { data: getProductResponse, isLoading: isGettingProduct, isSuccess, isError },
  ] = useLazyGetProductByIdQuery();
  const shouldShowLoading = useMinimumLoadingTime(isGettingProduct, 800);
  ...
  if (isError) return <ProductUnavailablePage />;
